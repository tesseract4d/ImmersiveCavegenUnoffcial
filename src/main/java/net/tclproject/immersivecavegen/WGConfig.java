...
public class WGConfig {
    ...
    public static void loadConfiguration() {
        ...
        livingCavesLush = config.getBoolean("Lush Living Caves", CATEGORY_TYPES, true, "Living caves that spawn under swamps not only have some occasional trees and flowers but also dirt, grass etc.");
        ...
        dimblacklist = config.getStringList("Dimension Blacklist", CATEGORY_REDUX, new String[]{"7"}, "Dimensions the changes will mostly not affect.");
        secondYLevelList = config.getStringList("Biomes Second Y Level Affects", CATEGORY_WORLD, new String[]{"Deep Ocean"}, "Biomes that the 'second Y level' will apply to. Replace one or more of the 'Deep Ocean's with another biome to use.");
