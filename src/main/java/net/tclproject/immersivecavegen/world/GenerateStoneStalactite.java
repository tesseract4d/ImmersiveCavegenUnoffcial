    ...
    if (distance <= 1) {
      if (!world.isAirBlock(x, y + 1, z) && !(world.getBlock(x, y - 1, z) instanceof net.minecraft.block.BlockLiquid)) {
        if (deepslateAbove && deepslateBelow) {
          world.setBlock(x, y, z, BlockInit.deepslateStalactiteBlock, 0, 3);
          return;
        }
      ...
      if (world.getBlock(x, botY - 1, z).isNormalCube() && random.nextInt(10) > 7) {
        if (deepslateBelow) {
          world.setBlock(x, botY, z, BlockInit.deepslateStalactiteBlock, CavesDecorator.randomChoice(9, 10), 3);
          return;
        }
        ...
        if (this.blockId == BlockInit.sandStalactiteBlock) {
          ...
          if (world.getBlock(x, botY - 1, z) == Blocks.stone || world.getBlock(x, botY - 1, z) == Blocks.sandstone)
            world.setBlock(x, botY - 1, z, BlockInit.scorchedStone, 0, 2);
      ...
      if (world.getBlock(x, y + 1, z).isNormalCube() && random.nextInt(10) > 7) {
        if (deepslateAbove) {
          world.setBlock(x, topY, z, BlockInit.deepslateStalactiteBlock, CavesDecorator.randomChoice(1, 2), 3);
          return;
        }
      ...
      if (world.getBlock(x, y + 1, z).isNormalCube()) {
        if (deepslateAbove) {
          world.setBlock(x, y, z, BlockInit.deepslateStalactiteBlock, 3, 3);
        } else {
      ...
      if (!world.getBlock(x, botY, z).getMaterial().isLiquid() && deepslateBelow) {
        ...
        if (aux != -1) {
          world.setBlock(x, botY, z, BlockInit.deepslateStalactiteBlock, aux, 3);
          gen = true;
        }
      ...
      if (genStala)
        while (true) {
          ...
          if (bottomMetadata == 8 && topY - 1 == botY) {
            world.setBlock(x, topY, z, deepslateAbove ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice(4, 5, 7, 6), 3);
            break;
          }
          topY--;
          j++;
          ...
          if (world.getBlock(x, topY, z) instanceof net.minecraft.block.BlockLiquid || world.getBlock(x, topY, z) instanceof net.minecraft.block.BlockStaticLiquid) {
            world.setBlock(x, topY + 1, z, deepslateAbove ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice(11), 3);
            return;
          }
          if (aux != 2 && !world.getBlock(x, topY, z).isNormalCube()) {
            if (world.isAirBlock(x, topY, z))
              world.setBlock(x, topY, z, deepslateAbove ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice(4, 5), 3);
            continue;
          }
          if (world.isAirBlock(x, topY, z))
            world.setBlock(x, topY, z, deepslateAbove ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice(11), 3);
          break;
        }
      if (gen)
        while (true) {
          ...
          if (topMetadata == 3 && botY + 1 == y) {
            world.setBlock(x, botY, z, deepslateBelow ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice(4, 5, 6, 7), 3);
            break;
          }
          j++;
          botY++;
          if (world.getBlock(x, botY, z) instanceof net.tclproject.immersivecavegen.blocks.BlockBaseStalactite) {
            if (world.getBlockMetadata(x, botY, z) == 4 || world.getBlockMetadata(x, botY, z) == 5) {
              world.setBlock(x, botY - 1, z, deepslateBelow ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice(4, 5), 3);
              break;
            }
            if (world.getBlockMetadata(x, botY, z) == 11) {
              world.setBlock(x, botY - 1, z, deepslateBelow ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice(12), 3);
              break;
            }
          }
          ...
          if (aux != 2) {
            if (world.isAirBlock(x, botY, z))
              world.setBlock(x, botY, z, deepslateBelow ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice(4, 5), 3);
            continue;
          }
          if (world.isAirBlock(x, botY, z))
            world.setBlock(x, botY, z, deepslateBelow ? BlockInit.deepslateStalactiteBlock : this.blockId, CavesDecorator.randomChoice( 12  ), 3);
          break;
        }
    }
  }
