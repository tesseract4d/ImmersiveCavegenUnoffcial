...
public class BlockHugeGlowingMushroom2 extends BlockHugeMushroom {
  ...
  public BlockHugeGlowingMushroom2(Material p_i45412_1_, int p_i45412_2_) {
  ...
  public Item getItem(World p_149694_1_, int p_149694_2_, int p_149694_3_, int p_149694_4_) {
    return Item.getItemById(Block.getIdFromBlock(BlockInit.mushroomBlockGreen));
  }
  ...
  public void registerBlockIcons(IIconRegister p_149651_1_) {
    ...
    this.field_149796_O = p_149651_1_.registerIcon(getTextureName() + "_inside2");
    this.field_149795_N = p_149651_1_.registerIcon(getTextureName() + "_skin_stem2");
  }
}
